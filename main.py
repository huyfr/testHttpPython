...
def compose_request(host, api, user_name, password, recipient, message_body):
    req = ''
    try:
        req = host + api +\
              ...
              '&messagedata=' + requests.utils.quote(message_body)
...
if __name__ == '__main__':
    request = compose_request(HOST, API, USER_NAME, PASSWORD, RECIPIENT, MESSAGE_BODY)
